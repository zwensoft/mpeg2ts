...
public class TVCT {
    ...
    public int get(IBitstream _F_bs) throws IOException {
        ...
        MapResult _F_mr;
        int _F_parse = 0;
        Util.trace(_F_bs.getpos(), 0, (int)0, "begin TVCT");
        _F_parse = 8;
        ...
        Util.trace(_F_bs.getpos()-_F_parse, _F_parse, (int)transport_stream_id, "transport_stream_id" +  " (" + transport_stream_id + ")");
        _F_parse = 2;
        ...
        Util.trace(_F_bs.getpos()-_F_parse, _F_parse, (int)num_channels_in_section, "num_channels_in_section" +  " (" + num_channels_in_section + ")");
        for (cn=0; cn<num_channels_in_section; cn++) {
            Util.trace(_F_bs.getpos(), 0, (int)0, "processing TVCTChannel channel");
            channel = new TVCTChannel();
        ...
        Util.trace(_F_bs.getpos()-_F_parse, _F_parse, (int)additional_descriptors_length, "additional_descriptors_length" +  " (" + additional_descriptors_length + ")");
        ...
        Util.trace(_F_bs.getpos(), 0, (int)0, "end TVCT");
        return _F_ret;
    }
