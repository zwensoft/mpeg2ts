...
public class ETT {
    ...
    public int get(IBitstream _F_bs) throws IOException {
        ...
        MapResult _F_mr;
        int _F_parse = 0;
        Util.trace(_F_bs.getpos(), 0, (int)0, "begin ETT");
        _F_parse = 8;
        ...
        if (ETT_table_id_extension != 0) {
            ...
            _F_ret++;
            Util.trace(_F_bs.getpos()-_F_parse, _F_parse, (int)ETT_table_id_extension, "ETT_table_id_extension" +  " (" + ETT_table_id_extension + ") [ERROR]");
        }
        else {
            Util.trace(_F_bs.getpos()-_F_parse, _F_parse, (int)ETT_table_id_extension, "ETT_table_id_extension" +  " (" + ETT_table_id_extension + ")");
        }
        _F_parse = 2;
        ...
        Util.trace(_F_bs.getpos()-_F_parse, _F_parse, (int)ETM_id, "ETM_id" +  " (" + ETM_id + ")");
        Util.trace(_F_bs.getpos(), 0, (int)0, "processing MultipleStringStructure extended_text_message");
        ...
        Util.trace(_F_bs.getpos(), 0, (int)0, "end ETT");
        return _F_ret;
    }
